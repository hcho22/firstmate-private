...
Its header and `--help` own the flags, family labels, lanes, changed-file map, and test-only selection of compatible installed Python and Node executables; this section only documents the entry points.

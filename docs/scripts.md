...
| `fm-evidence-import-stage.py` | Admit a trusted-host capability and consume one-time consent while staging or recovering producer-neutral evidence imports outside project worktrees |

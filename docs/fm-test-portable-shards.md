...
| portable serial 1-5 | job `timeout-minutes: 30` | Each balanced shard carries about 12.84 minutes of conservative assignment weight, while the hang tripwire stays above the roughly 20-minute slow-runner spread observed in CI. |

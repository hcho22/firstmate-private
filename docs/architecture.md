...
The [risk/recovery skill](../.agents/skills/risk-recovery/SKILL.md) owns brief assessment, behavioral evidence handoff, and linked ordinary release tasks; [`bin/fm-release.sh`](../bin/fm-release.sh) provides their read-only record interface.

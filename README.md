...
- **Risk, recovery, and release readiness** - ship briefs make impact and recovery explicit, and linked ordinary tasks retain planned release obligations after implementation lands; the [risk/recovery policy](.agents/skills/risk-recovery/SKILL.md) owns assessment, evidence, and release coordination without extending merge approval to production exposure.

...
# Ship briefs also render the shared risk/recovery interface from bin/fm-dod-lib.sh;
# .agents/skills/risk-recovery/SKILL.md owns its assessment and evidence policy.
